...
class College_Main {
    ...
    /*static
    {
        clgs.add(new College("CLG-0001", "Srinivas University, college of engineering and technology", 50));
        ...
        clgs.add(new College("CLG-0016", "NMAM Institute of Technology", 80));
